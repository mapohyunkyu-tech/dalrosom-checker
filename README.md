...
- 버섯 48개
- 견과·특용 49개
- 합계 943개 세부 키워드를 각각 독립 분석합니다.
- 대분류명(사과, 수박 등)만 분석하는 축약 DB가 아닙니다. 품종·유형·산지형 세부 키워드가 포함되어 있습니다.


## v1.0.4 수정
이전 버전의 축약 `data/products.json`이 남아 있어도 기본 943개 세부품목을 자동 병합·복구합니다. 각 품종은 NAVER API에 개별 키워드로 요청됩니다.
